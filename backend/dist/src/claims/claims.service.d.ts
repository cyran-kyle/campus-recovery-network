...
export declare class ClaimsService {
    ...
    createClaim(claimantId: string, matchId: string, answers: any[]): Promise<{
        match: {
            lostItem: {
                id: string;
                createdAt: Date;
    ...
    private compareText;
    approveClaim(claimId: string, notes?: string): Promise<{
        match: {
            lostItem: {
                id: string;
                createdAt: Date;
    ...
    rejectClaim(claimId: string, reason?: string): Promise<{
        match: {
            lostItem: {
                id: string;
                createdAt: Date;
